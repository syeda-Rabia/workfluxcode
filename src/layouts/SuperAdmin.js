...
import { superAdminScreenRoutes } from "routes.js";
...
const switchRoutes = (
  <Switch>
    {superAdminScreenRoutes.map((prop, key) => {
      if (prop.layout === "/su" && prop.visible) {
        return (
          <Route
    ...
    <Redirect from="/su" to="/su/overview" />
  </Switch>
);
